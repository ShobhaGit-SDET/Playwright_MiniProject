...
```ts
  ...
  8  | 
  9  |     const btnclickMe = await page.locator('#btnClickMe');
> 10 |     await btnclickMe.scrollIntoViewIfNeeded();
     |                      ^ Error: locator.scrollIntoViewIfNeeded: Test timeout of 30000ms exceeded.
  11 | 
  12 |     await btnclickMe.click();
  13 | 
  14 |    // page.locator('#btnClickMe').click();
  15 | 
  16 |    expect(await page.locator('#btnClickMe')).toHaveText('Click Me button clicked'); 
  17 |    
  18 |    await page.close();
  19 | 
  20 | });
